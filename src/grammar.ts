...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "relational_operator$subexpression$1", "symbols": [{"literal":":"}]},
    {"name": "relational_operator$subexpression$1$string$1", "symbols": [{"literal":":"}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "relational_operator$subexpression$1", "symbols": ["relational_operator$subexpression$1$string$1"]},
    {"name": "relational_operator$subexpression$1$string$2", "symbols": [{"literal":":"}, {"literal":">"}], "postprocess": (d) => d.join('')},
    {"name": "relational_operator$subexpression$1", "symbols": ["relational_operator$subexpression$1$string$2"]},
    {"name": "relational_operator$subexpression$1$string$3", "symbols": [{"literal":":"}, {"literal":"<"}], "postprocess": (d) => d.join('')},
    {"name": "relational_operator$subexpression$1", "symbols": ["relational_operator$subexpression$1$string$3"]},
    {"name": "relational_operator$subexpression$1$string$4", "symbols": [{"literal":":"}, {"literal":">"}, {"literal":"="}], "postprocess": (d) => d.join('')},
