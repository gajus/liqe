...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "two_op_expr$string$2", "symbols": [{"literal":"|"}, {"literal":"|"}], "postprocess": (d) => d.join('')},
    {"name": "two_op_expr", "symbols": ["pre_two_op_expr", "two_op_expr$string$2", "post_one_op_expr"], "postprocess": opExpr('OR')},
    {"name": "two_op_expr$string$3", "symbols": [{"literal":"A"}, {"literal":"N"}, {"literal":"D"}], "postprocess": (d) => d.join('')},
    {"name": "two_op_expr", "symbols": ["pre_two_op_expr", "two_op_expr$string$3", "post_one_op_expr"], "postprocess": opExpr('AND')},
    {"name": "two_op_expr$string$4", "symbols": [{"literal":"&"}, {"literal":"&"}], "postprocess": (d) => d.join('')},
    {"name": "two_op_expr", "symbols": ["pre_two_op_expr", "two_op_expr$string$4", "post_one_op_expr"], "postprocess": opExpr('AND')},
    ...
    {"name": "one_op_expr", "symbols": ["pre_expr"], "postprocess": id},
    ...
    {"name": "unquoted_value$ebnf$1", "symbols": [/[a-zA-Z*]/]},
    {"name": "unquoted_value$ebnf$1", "symbols": ["unquoted_value$ebnf$1", /[a-zA-Z*]/], "postprocess": (d) => d[0].concat([d[1]])},
